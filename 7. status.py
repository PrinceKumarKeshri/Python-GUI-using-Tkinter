# -*- coding: utf-8 -*-
"""
Created on Tue Sep 21 23:07:29 2021
...
status = Label(root, text = 'Image 1 of ' + str(len(myList)), bd = 5, relief = SUNKEN, anchor = E)
...
def forward(image_number):
    ...
    status = Label(root, text = 'Image '+ str(image_number) +' of ' + str(len(myList)), bd = 5, relief = SUNKEN, anchor = E)
